  ...
  return (
    ...
    >
      <style>{`
        ...
        /* gap between image & content (desktop) */
        ...
        @media (max-width: 768px) {
          ...
          /* item spacing & icon size smaller for mobile */
                ...
                <div className="about-area mt-3">
                  <div className="about-items">
                    ...
                    <div className="content">
                      <h5>Who We Are</h5>
                      <p>A diversified group with interests in Shipping, Logistics,
                        Distribution, IT, Clean Energy & Trading.</p>
                    </div>
                  </div>
                  ...
                  <div className="about-items">
                    ...
                    <div className="content">
                      <h5>Expertise</h5>
                      <p>Each business unit is led by experts ensuring sustainability,
                        execution & growth.</p>
                    </div>
                  </div>
                </div>
