  ...
  return (
    <section className="svs-wrap">
      ...
      <style>{`
        ...
        /* Left column */
        .svs-sub { margin: 0 0 8px; letter-spacing: .3px; font-size: .98rem; color: #5f6b7a; }
        .svs-title { margin: 0 0 16px; font-size: clamp(2.1rem, 1.4rem + 2.2vw, 3rem); line-height: 1.08; font-weight: 900; color: #0E0F2C; }

        .svs-list { display: grid; gap: 12px; margin-top: 14px; }
        .svs-item {
          display: flex; align-items: center; gap: 12px;
          padding: 14px 16px; border: 1px solid #e6eef6; border-radius: 16px; background: #f9fbff;
        ...
        .svs-icon {
          ...
          border: 1px solid rgba(38,182,224,.35); color: #1398c1;
        }
        ...
        /* Badges */
        .svs-badges {
          position: absolute; z-index: 2; left: 24px; top: 18px;
        ...
        /* Controls */
        .svs-controls { position: absolute; z-index: 2; right: 16px; bottom: 16px; display: flex; gap: 8px; }
        .svs-ctrl {
          width: 40px; height: 40px; border-radius: 12px; display: grid; place-items: center;
          background: rgba(255,255,255,.9); border: 1px solid rgba(0,0,0,.06);
          box-shadow: 0 8px 18px rgba(10,40,80,.08); color: #0b6b86; cursor: pointer;
        ...
        @media (max-width: 768px) {
          ...
          .svs-video-frame { aspect-ratio: 16 / 9; }
