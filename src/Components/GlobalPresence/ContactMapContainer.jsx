...
const ContactMapContainer = () => {
  ...
  return (
    <div className="w-full h-full flex justify-center bg-transparent">
      <div
        className={`rounded-2xl overflow-hidden relative w-full transition-all duration-300 ease-in-out ${
          isFullScreen ? 'max-w-full' : 'max-w-6xl'
        } my-3 bg-transparent shadow-none`}
      >
        {/* Map Header */}
        <div className="flex justify-between items-center p-3 border-b border-red-100 bg-gradient-to-r from-red-50/50 to-transparent backdrop-blur-sm">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className="text-red-600 border-red-200 hover:bg-red-50/40 backdrop-blur-sm"
            >
